...
// Function to handle button click for modifying timeline
...
document.getElementById("modifyTimelineBtn").addEventListener("click", handleModifyTimeline);

// Load events when the page is fully loaded
