                    ...
                    <IndexSectionContainer style={{
                        ...
                        <IndexSectionBackground>
                            <div class="eligibility-text">
                                ...
                                <br /><br />
                                <p style={{ fontFamily: "Tahoma" }}>
                                    CDM sophomores meeting the eligibility criteria can apply for the DePaul-Atlantis program. See below if you're eligible to apply.</p> </div>
                    ...
                    <IndexSectionContainer style={{
                        ...
                        <IndexSectionBackground>
                            <div class="degree-information-text">
                                <h2 style={{ color: "white", fontFamily: "Garamond", fontSize: "40px", fontWeight: "normal" }}>Degree Information</h2>
                                <p style={{ fontFamily: "Tahoma" }}>
