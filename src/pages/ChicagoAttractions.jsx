...
//Zain Qureshi worked on around 50 percent of this code. Did all comments for his portion, found images to use, gathered information to display on webpage
    ...
    return (
        <div style={styles.mainContent}> 
            <div style={styles.contentStyle}>
                <Heading>Chicago Attractions</Heading> //Header for webpage
                <img src={usClassPic} alt="USA Classroom" style={styles.testImage} /> //Image to be displayed
                <List> //Created unordered list detailing attractions in Chicagp
                    ...
                    </ListItem> //Short paragraph detailing Chicago attractions
                    <ListItem><strong>Cloud Gate (“The Bean”) </strong>-  Located in Millennium Park, this is one of Chicago's most popular sights and a work of public art by Anish Kapoor.</ListItem> //Bullet point for attraction
                    <ListItem><strong>Lincoln Park Zoo </strong> - Visit a zoo dedicated to connecting people with nature by providing a free, family-oriented wildlife experience in the heart of Chicago.</ListItem> //Bullet point for attraction
                    <ListItem><strong>Shedd Aquarium </strong>- Experience unforgettable encounters with belugas and bluegills, stingrays and sturgeons, sea stars, sea otters, and so many more animals from aquatic environments around the world.</ListItem> //Bullet point for attraction
                    <ListItem><strong> Buckingham Fountain </strong> - Witness one of the largest fountains in the world in Grant Park that streams water 150 feet in the air.</ListItem> //Bullet point for attraction
                    <ListItem><strong>Museums (free admission on specific days) </strong> //Nested list diving more into different museums
                <ul><p><li><strong>Museum of Science and Indsutry </strong> - One of the largest science museums in the world and is home to more than 400,000 square feet of hands-on exhibits designed to spark scientific inquiry and creativity.</li></p> //Bullet point for attraction
                    <p><li><strong>Field Museum </strong> - Immerse yourself in a natural history museum in Chicago, Illinois, and is one of the largest such museums in the world.</li></p> //Bullet point for attraction
                    <p><li><strong>Adler Planetarium</strong>  - Located on Chicago’s lakeshore since 1930, the Adler Planetarium connects people to the universe and each other and is dedicated to astronomy and astrophysics.</li></p> //Bullet point for attraction
                    <p><li><strong>Art Institute of Chicago </strong> - Experience one of the world’s major museums, housing an extraordinary collection of objects from across places, cultures, and time. </li></p> //Bullet point for attraction
                    <p><li><strong>Museum of Contemporary Art </strong> - Founded in 1967, the Museum of Contemporary Art Chicago champions the new and unexpected in contemporary art and culture through its exhibitions, performances, programs, and collection.</li></p></ul></ListItem> //Bullet point for attraction and closes nested list
                    <ListItem><strong>Navy Pier </strong> - This is where you go in Chicago for events, free public programs, attractions, culture, dining, shopping and more. It’s where fun lives large, whether you are a visitor or local, with family or friends.</ListItem>  //Bullet point for attraction
                    <ListItem><strong>The Willis Tower Skydeck</strong> - On the 103rd floor of the Willis Tower about 1,353 feet off the ground, you can see up to 50 miles away on a clear day, and in addition to views of every major Chicago attraction, four surrounding states are visible.</ListItem> //Bullet point for attraction
                    <ListItem><strong>The Chicago Riverwalk </strong> - The completed riverwalk has become a great Chicago attraction and a world-class neighborhood asset. It has already begun to provide a dynamic new commercial space and an uninterrupted route from Lake Street to the lake itself for both pedestrians and cyclists.</ListItem> //Bullet point for attraction
                </List>
            </div>
        </div>
    );
