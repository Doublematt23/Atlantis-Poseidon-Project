...
*---		   			
*---	    Zain Qureshi worked around 50 percent for this code. Commented his 
*---        portion of code in HTML, found images to use, gathered information to display on webpage
*---									
*-------------------------------------------------------------------------*/
