    ...
    return (
        <div style={styles.mainContent}>
            ...
            <ul style={styles.list}>
                ...
                <li style={styles.listItem}><strong>Research Methodology: </strong> Train for academic business research, Prepare for the LIU experience, and gain experience in research and peer review in a multicultural environment.</li>
            </ul>
        </div>
    );
};
